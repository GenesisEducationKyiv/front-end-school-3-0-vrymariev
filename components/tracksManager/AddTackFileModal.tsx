...
export const AddTackFileModal: React.FC<DeleteTrackButtonProps> = ({ id, isDialogOpen, onOpenChanged }) => {
	...
	return (
		<>
			<Dialog open={isDialogOpen} onOpenChange={onOpenChanged}>
				<DialogContent className="sm:max-w-md">
					...
					<DialogFooter className="flex justify-end gap-2 pt-4 ">
						<Button className="cursor-pointer" variant="outline" onClick={() => onOpenChanged(false)}>
							Cancel
						</Button>
						<Button
