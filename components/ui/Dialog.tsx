...
import { Root, Trigger, Content, Portal, Close, Overlay, Title, Description } from '@radix-ui/react-dialog';
...
function DialogContent({ className, children, ...props }: React.ComponentProps<typeof Content>) {
	return (
